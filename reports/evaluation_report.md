...
![Loss Curves Comparison](plots/training_loss_comparison.png)
...
![Validation F1-Macro Comparison](plots/val_f1_comparison.png)

#### 5.3. Hiệu năng cuối cùng trên tập Kiểm tra (Test Set)
Biểu đồ so sánh trực tiếp các chỉ số đánh giá chính giữa hai mô hình:

![Test Set Metrics Comparison](plots/test_metrics_comparison.png)
